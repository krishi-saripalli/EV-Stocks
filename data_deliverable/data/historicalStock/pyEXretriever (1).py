...
csvParse('/Users/imrihaggin1/Desktop/datascience/The-Truth/data_deliverable/data/historicalStock/driv_full-holdings_20220224.csv', tickers)
print(tickers)

data = []

client = p.Client(api_token = 'pk_867243fb385545f2aeb650e9e79cd86f', version='stable')
